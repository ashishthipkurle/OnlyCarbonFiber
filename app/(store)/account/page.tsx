    ...
    <div className="pt-[100px] md:pt-[140px] bg-[#F9F9F9] min-h-screen pb-24">
      ...
      <div className="max-w-[1000px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link href="/orders" className="bg-white p-8 border border-[#E8E8E8] hover:border-[#1A1A1A] hover:shadow-md transition-all group">
          ...
          <Link href="/account/addresses" className="bg-white p-8 border border-[#E8E8E8] hover:border-[#1A1A1A] hover:shadow-md transition-all group">
            <div className="w-12 h-12 bg-[#F9F9F9] flex items-center justify-center rounded-full mb-6 group-hover:bg-[#1A1A1A] group-hover:text-white transition-colors">
              <MapPin size={20} />
            </div>
          ...
          <Link href="/account/wishlist" className="bg-white p-8 border border-[#E8E8E8] hover:border-[#1A1A1A] hover:shadow-md transition-all group">
            <div className="w-12 h-12 bg-[#F9F9F9] flex items-center justify-center rounded-full mb-6 group-hover:bg-[#1A1A1A] group-hover:text-white transition-colors">
              <Heart size={20} />
            </div>
