        ...
        <div className="w-full flex flex-col md:flex-row h-auto md:h-[560px]">
          <div className="relative flex-1 overflow-hidden h-[400px] md:h-full bg-[#f0efed] group">
            ...
            <div className="absolute bottom-0 left-0 p-10">
              ...
              <Link href="/shop?category=lifestyle" className="font-['Jost'] text-[#1A1A1A] flex items-center gap-2 mt-4 hover:opacity-70 transition-opacity" style={{ fontSize: '14px', fontWeight: 500 }}>
          ...
          <div className="relative flex-1 overflow-hidden h-[400px] md:h-full bg-[#ebebea] group">
            ...
            <div className="absolute bottom-0 left-0 p-10">
              ...
              <Link href="/shop?category=auto" className="font-['Jost'] text-[#1A1A1A] flex items-center gap-2 mt-4 hover:opacity-70 transition-opacity" style={{ fontSize: '14px', fontWeight: 500 }}>
                EXPLORE<span style={{ marginLeft: '4px' }}>→</span>
              </Link>
            </div>
          </div>
